...
// Substance Function Controller//
   .controller('substanceFnCtrl',['$scope','$ionicModal','substanceFnService' , function ($scope,$ionicModal,substanceFnService){
  ...
  .controller('substanceCtrl',['$scope','$state','$rootScope','$timeout','solubilityService','stabilityService','substanceService','$ionicModal','$ionicPopup','$ionicPopover','$ionicLoading', function ($scope,$state,$rootScope,$timeout,solubilityService,stabilityService,substanceService,$ionicModal,$ionicPopup,$ionicPopover,$ionicLoading) {
    var scope = $rootScope;
    $scope.substances = [];
...
$scope.reset = function() {
  ...
  .controller('excipientCtrl',['$scope','$state','substanceService','excipientService','substanceFnService','$ionicModal','$ionicPopup','$ionicSlideBoxDelegate', function ($scope,$state,substanceService,excipientService,substanceFnService,$ionicModal,$ionicPopup,$ionicSlideBoxDelegate) {

    $scope.setkey = '';
    $scope.excipients = {};
    $scope.excipientInlist = excipientService.getCurrentExcipientlist();
    $scope.setSubstanceFunctions = [];
    $scope.currentExcipient = {substanceFunctions : '', usedWeight : '', minWeight : '',maxWeight : ''};
...
// Formulation Controller//
  .controller('formulationCtrl',['$scope','excipientService','formulationService','$ionicModal','$ionicPopup', function ($scope,excipientService,formulationService,$ionicModal,$ionicPopup) {
    
    $scope.excipients = [];
    $scope.formulationTypes = [{type : "Tablet Formulation"},{type : "Solution Formulation"}];
